...
export type CourseColumns = NamedColumns<{
	...
	createdBy: UserToCourse_createdBy["to"]["column"];
	updatedBy: UserToCourse_updatedBy["to"]["column"];
	deletedBy: UserToCourse_deletedBy["to"]["column"];
}>;

export type CourseRelations = NamedRelations<{
	courseEditions: CourseToCourseEdition_courseEditions["from"]["relation"];

	createdBy: UserToCourse_createdBy["to"]["relation"];
	updatedBy: UserToCourse_updatedBy["to"]["relation"];
	deletedBy: UserToCourse_deletedBy["to"]["relation"];
}>;
