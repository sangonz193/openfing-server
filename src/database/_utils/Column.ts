...
export type CreatedByIdColumn = FieldColumn<{ name: "created_by_id"; sqlType: "uuid" }>
export type UpdatedByIdColumn = FieldColumn<{ name: "updated_by_id"; sqlType: "uuid" }>
export type DeletedByIdColumn = FieldColumn<{ name: "deleted_by_id"; sqlType: "uuid" }>
