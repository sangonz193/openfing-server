...
# Recommended for development: http://localhost:5000/_files
FILES_URL=
...
#
# Nodemailer config.
# Any email address can be used, just look for for the SMTP server configuration for it.
#

# SMTP server host.
# e.g.: smtp.example.com, smtp.ethereal.email, smtp.office365.com
NODEMAILER_HOST=
...
# As is the case with the other Nodemailer configuration, must be real.
